    ...
    var methods = {
        ...
        init : function( options ) {
            ...
            return this.each(function(){
                ...
                if ( ! data ) {
                    ...
                    var html='<span class="name">'+$this.text().trim()+'</span> <a class="btn btn-primary button-1-line  btn-xs btnEdit" ><i style="font-size: 12px;" class="glyphicons pencil"></i></a>';
        ...
        clickEdit: function(){
            ...
            var html2='<input class="editable-input" type="text" data-value="'+text+'" value="'+text+'" maxlength="20" />'+
                '<a class="btn btn-primary button-1-line  btn-xs btnOk" ><i style="font-size: 12px;" class="glyphicons  ok"></i></a> '+
                '<a class="btn btn-primary button-1-line  btn-xs btnCancel" ><i style="font-size: 12px;" class="glyphicons remove"></i></a>';
        ...
        clickOk: function (){
            ...
            var html='<span class="name">'+$('.editable-input',$this).val()+'</span> <a class="btn btn-primary button-1-line  btn-xs btnEdit" ><i style="font-size: 12px;" class="glyphicons pencil"></i></a>';
        ...
        clickCancel: function (){
            ...
            var html='<span class="name">'+text+'</span> <a class="btn btn-primary button-1-line  btn-xs btnEdit" ><i style="font-size: 12px;" class="glyphicons pencil"></i></a>';
