...
function addAccessors($scope) {
    ...
    $scope.addPlaceholder = function(x,y, width, height, border_width, border_color, border_left, border_top, border_right, border_bootom ) {
        ...
        path.set({fill:'none', stroke:border_color, strokeWidth:border_width});
        ...
        var group1 = new fabric.Group([ path, rect], { left: x, top: y });
