...
$this->params['breadcrumbs'][] = ['label'=>Yii::t('app', 'Пользователи'), 'url'=> Url::toRoute(['super-admin/users', 'role'=>$model->role]) ];
$this->params['breadcrumbs'][] = $model->username;
?>
<div class="site-profile">
    <h2><?php echo Yii::t('app', 'Аккаунт пользователя:') ?> <?= Html::encode($model->username) ?></h2>
        ...
        <div class="row ">
            <div class="col-xs-6  ">
                ...
                <div class="">
                    ...
                    <?= $form->field($model, 'id')->begin(); ?>
                    <?= Html::activeLabel($model,'id', ['label' => Yii::t('app', 'ИД пользователя:'), 'class'=>'control-label col-xs-6']); ?>
                    <div class="col-xs-6">
                        <?= Html::activeTextInput($model, 'id', ['id'=>'username', 'class'=>'form-control ', 'size'=>'7', 'disabled'=>'disabled']) ?>
                    </div>
                    ...
                    <?= Html::activeLabel($model,'role', ['label' => Yii::t('app', 'Роль:'), 'class'=>'control-label col-xs-6']); ?>
                    <div class="col-xs-6">
                        <?= Html::activeDropDownList($model, 'role', $roles,['id'=>'role', 'class'=>'form-control ']) ?>
                    </div>
