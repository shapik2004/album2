<svg width="100%" viewBox="0 0 716 366">

    <svg width="100%" height="100%" x="0" y="0" viewBox="0 0 716 366" >
        <svg version="1.1"
             xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:a="http://ns.adobe.com/AdobeSVGViewerExtensions/3.0/"
             x="0" y="0" width="716"  height="366" viewBox="0 0.354 924 480" preserveAspectRatio="none"
...
<defs>
	...
	C923,477.008,921.654,478.354,920,478.354z"/>
            <linearGradient id="spine_2_" gradientUnits="userSpaceOnUse" x1="448" y1="240.3535" x2="476" y2="240.3535">
                <stop  offset="0" style="stop-color:#1B1B1D"/>
                <stop  offset="0.2115" style="stop-color:#232426"/>
                <stop  offset="0.5" style="stop-color:#262729"/>
                <stop  offset="0.7885" style="stop-color:#232426"/>
    ...
    <svg width="700" height="350" x="8" y="8" viewBox="0 0 700 350">
        <?php echo $page['svg_thumb']; ?>
    </svg>
</svg>