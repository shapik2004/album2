...
<div id="wrapper" class="wrapper">
    ...
    <nav id="navbar" class="navbar navbar-default" role="navigation">
        <div class="container-fluid">
              ...
              */
              ...
              ?>
                ...
                <div class="navbar-brand" >
                        ...
                        <a href="#" ><span class="photobook-title" ><?php echo $model->name; ?></span> <span class="color-gray current-state-title"><?php echo Yii::t('app', 'Обложка') ?></span></a>
                </div>
            ...
            <div class="navbar-form navbar-right" >
                ...
                <?php if($model->status==Photobook::STATUS_NEW ||
                    $model->status==Photobook::STATUS_READY_SENT_TO_CLIENT ||
                    $model->status==Photobook::STATUS_WAIT_EDIT_FROM_CUSTOMER  ):
                    ?>

                    <div class="btn-group" style="" >
                        <a class="btn btn-primary button-2-line "  href="<?php echo Url::toRoute(['photobooks/send-to-print', 'ref'=>AlphaId::id($model->user_id), 'id'=>AlphaId::id($model->id)]); ?>"  >
                            <div class="button-col button-icon ">
                ...
                <?php if($model->status==Photobook::STATUS_NEW ||
                    ...
                    <div class="btn-group" style="" >
                        <a class="btn btn-primary button-2-line "  href="<?php echo Url::toRoute(['photobooks/edit', 'ref'=>AlphaId::id($model->user_id), 'id'=>AlphaId::id($model->id)]); ?>"  >
                            <div class="button-col button-icon ">
    ...
    <div id="book-container" class="book-container" data-access="view" data-status="" data-value=""
